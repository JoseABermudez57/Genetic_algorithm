...
min_values = tk.Checkbutton(window, text="Min", variable=resultingValue, onvalue=1)
max_values = tk.Checkbutton(window, text="Max", variable=resultingValue, onvalue=2)
